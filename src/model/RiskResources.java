...
public class RiskResources
{
    ...
    private void setAllTerritories()
    {
        ...
        { eu4, eu5, eu7, af1 };
        Territory[] eu7Adj =
        { eu3, eu5, eu6, as10, af1, af2 };

        Territory[] af1Adj =
        { sa3, eu6, eu7, af2, af3, af4 };
        Territory[] af2Adj =
        { eu7, as10, af1, af3 };
        Territory[] af3Adj =
        { as10, af1, af2, af4, af6 };
        Territory[] af4Adj =
        { af1, af2, af3, af5 };
        Territory[] af5Adj =
        { af3, af4, af6 };
        ...
        { as1, as2, as3, as7 };
        Territory[] as6Adj =
        { eu5, as4, as9, as10, as11 };
        Territory[] as7Adj =
        { as1, as5, as8, as9 };
        Territory[] as8Adj =
        { as3, as7 };
        Territory[] as9Adj =
        { as1, as4, as7, as11, as12 };
        Territory[] as10Adj =
        { eu3, eu7, af2, af3, as6, as11 };
        Territory[] as11Adj =
        { as6, as9, as10, as12 };
        Territory[] as12Adj =
        { as9, as11, ar1 };
